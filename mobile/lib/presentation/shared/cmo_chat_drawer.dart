        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.circular(16).copyWith(topLeft: const Radius.circular(2)),
              ...
              child: Text(
                msg.content,
                style: const TextStyle(fontSize: 13.5, color: Color(0xFF1E293B), height: 1.45),
              ),
            ),
            if (msg.suggestedActions.isNotEmpty) ...[
              ...
              Wrap(
                ...
                children: msg.suggestedActions.map((act) {
                  return ActionChip(
                    avatar: const Icon(Icons.touch_app_rounded, size: 13, color: Color(0xFF2563EB)),
                    label: Text(
                      act.label,
